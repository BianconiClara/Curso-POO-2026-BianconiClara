...
template <> constexpr inline auto EditorPrincipal::qt_create_metaobjectdata<qt_meta_tag_ZN15EditorPrincipalE_t>()
{
    ...
    QtMocHelpers::StringRefStorage qt_stringData {
        ...
        "actualizarContextoCursor",
        "marcarLineaActualComoEditada",
        "validarLineaActual"
    };
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'cargarPlantillaActual'
        QtMocHelpers::SlotData<void()>(6, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'actualizarContextoCursor'
        QtMocHelpers::SlotData<void()>(7, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'marcarLineaActualComoEditada'
        QtMocHelpers::SlotData<void()>(8, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'validarLineaActual'
...
void EditorPrincipal::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->exportarJpg(); break;
        case 2: _t->cerrarVentana(); break;
        case 3: _t->cargarPlantillaActual(); break;
        case 4: _t->actualizarContextoCursor(); break;
        case 5: _t->marcarLineaActualComoEditada(); break;
        case 6: _t->validarLineaActual(); break;
        default: ;
        }
    }
}
