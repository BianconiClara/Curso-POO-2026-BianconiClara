    ...
    , m_config(AppConfigLoader::load())
{
    ...
    connect(m_loginWindow, &LoginWindow::loginValidated, this, &AppController::onLoginValidated);
    connect(m_networkService, &NetworkService::weatherUpdated,
            m_climaWidget, &ClimaWidget::setWeatherInfo);
    connect(m_networkService, &NetworkService::backgroundReady,
            this, &AppController::onBackgroundReady);
    connect(m_networkService, &NetworkService::backgroundError,
            this, &AppController::onBackgroundError);
}
