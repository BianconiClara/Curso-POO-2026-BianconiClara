...
Proyecto de escritorio en Qt Widgets para resolver la consigna de login con clima, imagen de fondo descargada, caché local, proxy, logs y modo offline.
...
- El fondo offline reutiliza la imagen `imagen-fondo.jpg` que ya existía en esta carpeta
...
### Pantalla de login cuando se ingresa una vez mal la contraseña

![pantalla login 2](Imagenes/login-error.png)

Pantalla principal con currículum 

![pantalla](Imagenes/pantallaprincipal.png)
